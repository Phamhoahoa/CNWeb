...
(post_id,author_id,post_img,post_time,post_content,p_title,p_privacy,class_id)
VALUES
( :post_id, :p_author_id, :p_img, :p_time, :p_content, :p_title, :p_privacy, :class_id)
";
...
$insert_post_toDB->bindParam(':class_id', $class_id,PDO::PARAM_STR);
...
$iptdbsql = "INSERT INTO wpost
(post_id,author_id,post_time,post_content,p_title,p_privacy,class_id)
VALUES
( :post_id, :p_author_id, :p_time, :p_content, :p_title, :p_privacy, :class_id)
";
$insert_post_toDB = $conn->prepare($iptdbsql);
$insert_post_toDB->bindParam(':post_id', $post_id,PDO::PARAM_STR);
$insert_post_toDB->bindParam(':p_author_id', $p_author_id,PDO::PARAM_INT);
