<?php
session_start();
$main_class_id = $_SESSION['class_id'];
include('../config/connect.php');
include ("num_k_m_count.php");
$getTriendsPagesSql = "SELECT signup.* FROM signup, mystudy WHERE signup.id = mystudy.id AND mystudy.class_id = $main_class_id ORDER BY followers DESC LIMIT 6";
...
$emptypost = "";
$public = "0";
$getTriendsPostsSql = "SELECT * FROM wpost WHERE post_content!= :emptypost AND p_privacy = :public AND wpost.class_id = $main_class_id ORDER BY p_likes DESC LIMIT 6";
