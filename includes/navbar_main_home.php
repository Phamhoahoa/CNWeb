...
<nav class="navbar navbar-inverse" style="position:fixed;top:0;right:0;left:0;z-index: 2;">
    <div class="container-fluid" style="width: 1040px;">
        <div class="navbar-header" style="float: <?php echo lang('float'); ?>;">
            ...
            <a class="navbar-brand" href="<?php echo $dircheckPath; ?>home"><span style="font-size: 25px;">HustWeb</span></a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="<?php echo lang('ul_navbar_nav1'); ?>">
                ...
                <li><a href="javascript:void(0);" style="padding: 16px 10px;" id="nav_Class_Btn">Class<span id="classesCount"></span></a>
                <div class="navbar_fetchBox" id="classes_box">
                <div style="position:relative;padding: 5px 10px;border-bottom: 1px solid #ccc;text-align: <?php echo lang('textAlign'); ?>"> Classes
                    <span class="toTopArrow" span class='toTopArrow' style="position: absolute; top: -10px;<?php echo lang('float'); ?>:8px;"></span>
                </div>
                <div id="classes_rP" class="scrollbar" style="max-height: 450px; overflow-y: scroll;">
                    <div id="classes_r" data-load="0">
                        <div id="classes_data"></div>
                        <p style='width: 100%;border:none;display: none' id="classes_loading" align='center'><img src='<?php echo $dircheckPath; ?>imgs/loading_video.gif' style='width:20px;box-shadow: none;height: 20px;'></p>
                        <p id="classes_noMore" style='display:none;color:#9a9a9a;font-size:14px;text-align:center;'><?php echo lang('no_classes'); ?></p>
                         <input type="hidden" id="classes_load" value="0"> 
                    </div>
                </div>
                <div id='sqresultClassItem' align='center' style='background: #efefef; border: 1px solid #e0e0e0;'>
                <p style='font-size:13px;'><?php echo lang('see_all'); ?>
                </p>
                </div>
                </div>
