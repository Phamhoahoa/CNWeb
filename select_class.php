...
//     header("location: http://localhost:8888/teamwork/select_class.php");
// }
...
<head>
    <title><? echo lang('welcome'); ?> | HustWeb</title>
    <meta charset="UTF-8">
    ...
    <meta name="keywords" content="homepage,main,login,social network,social media,HustWeb,meet,free platform">
    ...
    <!--============[ Nav bar ]============-->
        <div class="login_signup_navbar">
                <a href="index" class="login_signup_navbarLinks">HustWeb</a>
        ...
        <h3 align="center"><? echo lang('welcome_to'); ?> HustWeb</h3>
        <p align="center" style="color: #999; margin-bottom: 25px;"><? echo lang('HustWeb_main_string'); ?>.</p>
            <div style="display: flex;">
                <div style="width: 100%;">
                    <br><h4>Choose class</h4>
                    
                    <p>
                        <select id="login_signup_textfield" style="margin: 5px; padding: 0px 10px; max-width: 110px; height: 35px;" name="w_privacy">
                        <option selected="">1</option>
                        <option>2</option>
                        <option></span>3</option>
                        </select>
                    </p>
                    ...
                    <button type="submit" class="login_signup_btn1" id="loginFunCode">OK</button>
                    <p id="login_wait" style="margin: 0px;"></p>
                </div>
                <div style="width: 100%;text-align: center;">
                    <img src="imgs/main_icons/pc_main.png" alt="HustWeb" style="width: 300px;" />
                </div>
            </div>
        </div>
