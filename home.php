...
<!--=============================[ NavBar ]========================================-->
<?php include "includes/navbar_main_home.php"; ?>
<!--=============================[ Div_Container ]========================================-->
...
<!--====================================[ Center col3 ]============================================-->
        <?php 
            $mClassiD = $_SESSION['class_id'];
            $ClassName = "Class";
            $ClassId = "ClassId";
            if($mClassiD != -1){
                $getC_sql = "SELECT * FROM myclass WHERE id =:mClassiD";
                $getC = $conn->prepare($getC_sql);
                $getC->bindParam(':mClassiD',$mClassiD,PDO::PARAM_INT);
                $getC->execute();
                $OBJ = $getC->fetch(PDO::FETCH_ASSOC);
                $ClassName = $OBJ['name'];
                $ClassId = $OBJ['malop'];
            }
        ?>
        <div align="left">
         <div id="centerCol3" style="width: 310px">
          ...
          <div id="trendingWorldWide">
              <p class="trendingTitle_CenterCol_3"><span class="fa fa-globe"></span> <?php echo "$ClassName _ $ClassId" ?></p>
