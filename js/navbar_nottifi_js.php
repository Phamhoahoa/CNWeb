...
// ============================================ classes function ============================================
function getClasses(obj,reqToFetch){
var path = "<?php echo $dircheckPath; ?>";
var whatF = "class";
var load = $('#'+obj+'_load').val();
$.ajax({
...
// ============================================ click on class ============================================
$("#nav_Class_Btn").click(function(e){
$("#notifications_box").hide();
$("#classes_box").show();

getClasses('classes','getNew');
e.stopPropagation();
});
$("#nav_Class_Btn").keyup(function(e){
e.stopPropagation();
});
// ============================================ classes on scroll >> loadmore =============================
$("#classes_rP").scroll(function(){
    var o = document.getElementById('classes_rP');
    if(o.offsetHeight + o.scrollTop + 1 >= o.scrollHeight){
        getClasses('classes','loadMore');
    }
});
// ========================================================================================================
</script>